...
_Generated: 2026-06-23T11:09:02.356Z_
...
Workspace `mcp.json` _(folder: ST.Billy)_

- **c:\Users\Manu\Desktop\ST.Billy\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Manu\.claude.json** — _File missing_
