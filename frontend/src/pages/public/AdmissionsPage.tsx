    ...
    <div className="space-y-12">
      ...
      <section className="container-main">
        ...
        <div className="space-y-4">
          {[
            { q: 'When are admissions open?', a: 'Admissions are open from January to March every year.' },
            { q: 'What is the admission fee?', a: 'Fees vary by grade level. Please contact the office for details.' },
            { q: 'Do you offer scholarships?', a: 'Yes, merit-based and need-based scholarships are available.' },
          ].map((faq, i) => (
